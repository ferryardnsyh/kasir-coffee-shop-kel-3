...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KasirApp/logo.jpg"))); // NOI18N
        jLabel5.setText("jLabel5");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel3.setText("please login your account");
    ...
    if (user.login(username, password)) {
        ...
        // Membuka file TambahPesanan.java
        TambahPesanan pesanan = new TambahPesanan();
